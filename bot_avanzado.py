...
First, a few callback functions are defined.
...
from telegram.ext import ReplyMarkup
...
def gender(bot, update):
    ...
    update.message.reply_text('I see! Please send me a photo of yourself, '
                              'so I know what you look like, or send /skip'
...
def skip_photo(bot, update):
    ...
    update.message.reply_text('I bet you look great! Now,'
