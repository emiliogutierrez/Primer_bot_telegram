...
#                bot.send_photo(cid, photo)
            ...
            print "[" + str(cid) + "]: Escribio : " +  str(m.text) + " Envia imagen " + str(zona) +  " a :" + str(m.chat.first_name) + " --  " + str(actu)
        elif m.content_type == 'location':
            print "[" + str(cid) + "]: Escribio : " +  str(m.chat.first_name) + str(usuario.last_name)
            bot.send_location(cid, -34.966666666667, -67.7)
